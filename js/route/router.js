// Ruteo ortogonal — función pura. Sin DOM, sin LiteGraph, sin app.
//
// Tomado de comfyui-cable-management (MIT), de Vedran Aberle Tokić:
// https://github.com/vtokic/comfyui-cable-management — fichero web/pathing/router.js.
// Se copia sin tocar la geometría: es un motor puro, encaja con cómo está
// montado js/spline/ y reescribirlo sólo serviría para tener nuestros propios
...
//
// ─────────────────────────────────────────────────────────────────────────────
// A* sobre una rejilla de Hanan dispersa: los carriles son los bordes de los
// rectángulos de los nodos, inflados por `clearance`. El coste es la longitud
// más una penalización por giro, y cruzar un nodo no está prohibido —cuesta
// ocho veces—, así que la búsqueda nunca falla: minimiza el tramo tapado.
//
// route() devuelve los vértices en coordenadas de grafo [salida, ...giros...,
// llegada], o null cuando el caso es trivial (y entonces el cable lo pinta el
// renderizador de siempre).
